...
def menu():
    ...
    if choice == 1:
        ...
        print("Github Link: https://github.com/discordpill/Discord-Token-Generator\n")
        print("Discord Server Link: https://anonix.xyz/discord")
        print("My name is Benz, you can find my discord there.")
        input("Click Enter to return to menu")
        return menu()
    elif choice == 4:
        print("Developer of this program is benz, this program is made in python.")
        input("Click Enter to return to menu")
        return menu()
    elif choice == 5:
        locked = 0
